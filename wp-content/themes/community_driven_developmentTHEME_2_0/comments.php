...
?>
	...
	<?php if ( have_comments() ) : ?>
		<header>
			<h2 class="comments-title">
				<?php
					printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', '_tk' ),
	...
	<?php comment_form( $args = array(
			  ...
			  'title_reply'       => __( 'Write a comment', '_tk' ),  // that's the wordpress default value! delete it or edit it ;)
			  'title_reply_to'    => __( 'Write a Comment to %s', '_tk' ),  // that's the wordpress default value! delete it or edit it ;)
			  'cancel_reply_link' => __( 'Cancel Comment', '_tk' ),  // that's the wordpress default value! delete it or edit it ;)
