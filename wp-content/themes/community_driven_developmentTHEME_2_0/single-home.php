...
<a href="<?php echo get_post_type_archive_link('indev'); ?>"><button type="button" class="RJP-Lightbtn">SEE ALL INDEV</button></a>
<br>
<br>
<!---------------------- END INDEV ---------------------->
<!---------------------- START FEATURES ---------------------->
<div class="RJP-Darkback">
	<div class="features_container">
		...
		wp_reset_query();
		?>
		<a href="<?php echo get_post_type_archive_link('feature'); ?>"><button type="button" class="RJP-Darkbtn">ALL ABOUT CDD</button></a> 
		</div>
</div>
<!---------------------- END FEATURES ---------------------->
