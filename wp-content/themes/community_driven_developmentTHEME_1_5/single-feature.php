...
//DEV VOTING SYSTEM------------------- 
	...
	<!--Feature has <span class='vote_count'><?php //echo $vote_count;?></span> Dev-points and needs <?php //echo get_post_meta( $post_id, 'dev-point-requirement', true );?> to start development.<br>-->
	<?php
	if($user_ID){?>
