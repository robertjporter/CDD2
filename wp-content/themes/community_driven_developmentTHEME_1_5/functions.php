    ...
    if(is_array($objectives[0])){
        foreach( $objectives[0] as $complete ) {
            if ( isset( $complete['title'] ) || isset( $complete['complete'] ) ) {
                printf( '<p> Objective Description <input type="text" size="35" name="objectives[%1$s][title]" value="%2$s" /> -- Not started<input type="range" min="0" max="2" name="objectives[%1$s][complete]" value="%3$s" />Complete<button  class="remove">%4$s</button></p>', $c, $complete['title'], $complete['complete'], __( 'Remove' ) );
                $c = $c +1;
            }
        }
    }
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".add").click(function() {
            ...
            $('#here').append('<p> Objective Description <input type="text" size="35" name="objectives['+count+'][title]" value="" /> -- Not started<input type="range" min="0" max="2" name="objectives['+count+'][complete]" value="0" />Complete<button  class="remove">Remove</button></p>' );
            return false;
        });
    ...
    if(is_array($updates[0])){
        foreach( $updates[0] as $date ) {
            if ( isset( $date['title'] ) || isset( $date['date'] ) ) {
                printf( '<p> Update Description <input type="text" size="35" name="updates[%1$s][title]" value="%2$s" /> -- Date<input type="date" name="updates[%1$s][date]" value="%3$s" /><button  class="removeUpdate">%4$s</button></p>', $cu, $date['title'], $date['date'], __( 'RemoveUpdate' ) );
                $cu = $cu +1;
            }
        }
    }
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".addUpdate").click(function() {
            ...
            $('#hereUpdate').append('<p> Update Description <input type="text" size="35" name="updates['+count+'][title]" value="" /> -- Date <input type="date" name="updates['+count+'][date]" value="<?php echo date('Y-m-d') ?>"/> <button  class="removeUpdate">Remove Update</button></p>' );
            return false;
